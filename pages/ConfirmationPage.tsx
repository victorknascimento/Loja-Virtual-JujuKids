...
const ConfirmationPage = () => {
  return (
    <div className="text-center bg-white p-10 rounded-lg shadow-lg max-w-2xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-fuchsia-700 mb-2">Obrigado pela sua compra!</h1>
      ...
      <Link to="/" className="mt-6 inline-block px-8 py-3 bg-fuchsia-500 text-white font-bold rounded-lg hover:bg-fuchsia-600 transition-colors">
        Voltar para a Loja
      </Link>
    </div>
  );
